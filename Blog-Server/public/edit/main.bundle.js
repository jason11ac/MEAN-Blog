...
var BlogService = /** @class */ (function () {
    ...
    BlogService.prototype.fetchPosts = function () {
        ...
        this.http.get(fetch_posts_url).subscribe(function (data) {
            _this.post_test = data;
            for (var i = 0; i < _this.post_test.length; i++) {
                _this.posts.push(_this.post_test[i]);
            }
            _this.sortArray();
            _this.maxPostId = 0;
    ...
    BlogService.prototype.newPost = function () {
        ...
        this.addPost(newPost, username).subscribe(function (data) { console.log('VALUE RECEIVED: ' + data); }, function (error) { console.log('New post added successfully'); });
        return newPost;
    };
